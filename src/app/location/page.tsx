    ...
    >
      <ReactLenis root>
        ...
        <div id="location-content" className="py-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto text-center">
          <h1 className="text-4xl font-extrabold mb-4">Maintenance Plumbing & Electric Services</h1>
          <p className="text-lg mb-8 text-neutral-600">Building 18 Street 910, Doha</p>
          <div className="w-full h-[500px] rounded-2xl overflow-hidden shadow-lg border border-neutral-200">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3607.728877546853!2d51.5273!3d25.2867!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e45c50c05986873%3A0x673c090333d45672!2sDoha%2C%20Qatar!5e0!3m2!1sen!2sqa!4v1700000000000!5m2!1sen!2sqa"
              width="100%" 
              height="100%" 
              style={{ border: 0 }} 
              allowFullScreen 
