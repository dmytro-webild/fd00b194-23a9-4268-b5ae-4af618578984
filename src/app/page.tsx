...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      buttons={[
        {
          text: "Call Now",          href: "tel:72108374"},
      ]}
      mediaItems={[
        {
  ...
  <div id="pricing" data-section="pricing">
      ...
      plans={[
        {
          id: "emergency",          badge: "24/7 Urgent",          price: "Call Us",          subtitle: "Immediate response for critical maintenance.",          features: [
            "Priority 24/7 Support",            "Rapid Deployment",            "Expert Diagnostic"],
          buttons: [
            {
              text: "Contact Now",              href: "tel:72108374"},
          ],
        },
        {
          id: "regular",          badge: "Routine",          price: "Custom Quote",          subtitle: "Scheduled maintenance for peace of mind.",          features: [
            "Monthly Inspection",            "Preventative Care",            "Report Documentation"],
          buttons: [
            {
  ...
  <div id="footer" data-section="footer">
      ...
      columns={[
        ...
        },
        {
          title: "Support",          items: [
            {
              label: "Call: 7210 8374",              href: "tel:72108374"},
            {
