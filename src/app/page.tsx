      ...
      features={[
        {
          ...
          description: "Reliable plumbing repair and professional drain cleaning to keep your systems flowing.",
          icon: Droplets,
          mediaItems: [
            {
        ...
        },
        {
          ...
          description: "Expert electrical maintenance, troubleshooting, and safety inspections for all property types.",
          icon: Zap,
          mediaItems: [
            {
        ...
        },
        {
          ...
          description: "Precision installation and repair for water heaters and high-performance pumping systems.",
          icon: Droplet,
          mediaItems: [
            {
      ...
      plans={[
        {
          ...
          badge: "24/7 Urgent",
          price: "Call Us",
          subtitle: "Immediate response for critical maintenance.",
          features: [
        ...
        },
        {
          ...
          badge: "Routine",
          price: "Custom Quote",
          subtitle: "Scheduled maintenance for peace of mind.",
          features: [
            "Monthly Inspection",
            "Preventative Care",
      ...
      testimonials={[
        {
          ...
          testimonial: "Excellent service and very prompt response. Highly recommended!",
        ...
        },
        {
          ...
          name: "Sarah J.",
          role: "Homeowner",
          testimonial: "Professional electrical work. They resolved the issue quickly and cleaned up perfectly.",
        ...
        },
        {
          ...
          name: "Omar F.",
          role: "Business Owner",
          testimonial: "Very knowledgeable team. Our water heaters were fixed the same day.",
          imageSrc: "http://img.b2bpic.net/free-photo/real-estate-office-desk_23-2147653308.jpg",
        },
        {
          id: "4",
          name: "Khalid M.",
          role: "Tenant",
          testimonial: "Best plumbing service in Qatar. Polite, fast, and reliable.",
        ...
        },
        {
          ...
          name: "Fatima A.",
          role: "Villa Owner",
          testimonial: "Exceptional care and attention to detail. True maintenance experts.",
          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3BgPWZ0BZZJN7WGA5KukUvigqPy/uploaded-1774910755538-dolkwt4f.jpg",
        },
      ]}
      ...
      faqs={[
        {
          ...
          content: "Yes, our team is available 24/7 for all plumbing and electrical emergencies.",
        },
        {
          id: "2",
          title: "What areas do you serve?",
          content: "We proudly serve clients across Qatar with professional maintenance.",
        },
        {
          id: "3",
          title: "How can I book a service?",
          content: "Simply call us at 7210 8374 or contact us through our website.",
        },
      ]}
